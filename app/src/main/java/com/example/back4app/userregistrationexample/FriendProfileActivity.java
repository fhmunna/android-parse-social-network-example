...
public class FriendProfileActivity extends AppCompatActivity implements View.OnClickListener ,SimpleRatingBar.OnRatingBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        friendUserId=bundle.getString("key_object_id");
...
*/
       ...
       // if (currentUser != null) {
            ...
            textView_username.setText(friendUserId);
      ...
      //  }
        ...
        home_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent homeIntent = new Intent(FriendProfileActivity.this,PostActivity.class);
        ...
        friend_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent homeIntent = new Intent(FriendProfileActivity.this,FriendListActivity.class);
                startActivity(homeIntent);
        ...
        chat_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent homeIntent = new Intent(FriendProfileActivity.this,ChatActivity.class);
                startActivity(homeIntent);
    ...
    private void pullEducation() {
      ...
      //  if (currentUser != null) {
            ...
            query.whereEqualTo("userId", friendUserId);
...
//                    ParseObject experience = new ParseObject("Experience");
                ...
                experience.put("userId", friendUserId);
...
//                    ParseObject education = new ParseObject("Education");
                ...
                education.put("userId", friendUserId);
...
//                            meAdapter.notifyDataSetChanged();
    ...
    private void putRating(String ratingValue) {

        final ParseUser currentUser = ParseUser.getCurrentUser();

        Rating  rating = new Rating();
        rating.setRatingReference(friendUserId);
